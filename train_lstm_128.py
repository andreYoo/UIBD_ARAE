...
summary = SummaryWriter('./logs/type_cell/lstm_128')
...
def train(model,discriminator, optimizer,optimizer_D, train_loader, grad_clip,epoch):
    ...
    for b, batch in enumerate(train_loader):
        ...
        z = Variable(torch.rand((_filted_len,128)).cuda())
...
def main():
    ...
    encoder = Encoder(log_numbers, embed_size, hidden_size, n_layers=2, dropout=0.5,cell_type='LSTM')
    decoder = Decoder(hidden_size, hidden_size_dec, n_layers=1, dropout=0.5,cell_type='LSTM')
    ...
    for e in range(1, args.epochs+1):
        ...
        if e%10==0:
            ...
            if not os.path.isdir("./save"):
                os.makedirs("./save")
            torch.save(rvae.state_dict(), './save/m_cell/lstm/128/arae_lstm_128_%d.pt' % (e))
            #print("[!] testing model...")
