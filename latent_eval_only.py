...
def validation(model, val_loader, epoch):
    ...
    tsne_model = TSNE(learning_rate=100,n_jobs=12)
    ...
    plt.savefig('%d-epoch_distribution.pdf'%(epoch))
...
def main():
    ...
    train_set = tmp_set[0:_train_lenth-val_num]
    dynamics_mask = tmp_mask[0:_train_lenth-val_num]
    ...
    for e in range(1, args.epochs+1):
        ...
        if e%10==0:
            ...
            if not os.path.isdir("./save"):
                os.makedirs("./save")
            torch.save(rvae.state_dict(), './save/arae_%d.pt' % (e))
            # print("[!] testing model...")
