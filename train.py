...
from models.Nets import Encoder, Decoder, RVAE
...
def main():
    ...
    optimizer = optim.Adam(rvae.parameters(), lr=args.lr)
    print(rvae)

    best_val_loss = None
    for e in range(1, args.epochs+1):
        train(e, rvae, optimizer, train_iter,
        ...
        if not best_val_loss or val_loss < best_val_loss:
            ...
            if not os.path.isdir(".save"):
                os.makedirs(".save")
            torch.save(rvae.state_dict(), './.save/seq2seq_%d.pt' % (e))
            best_val_loss = val_loss
    test_loss = evaluate(rvae, test_iter, en_size, DE, EN)
