...
summary = SummaryWriter('./logs/type_input/dense256')
...
def validation(model, val_loader, epoch):
    ...
    plt.savefig('./plot_dist/dense256_%d-epoch_arae_latent_distribution.pdf'%(epoch))
...
def main():
    ...
    embed_size = 256
    log_numbers = 146
    hidden_size_dec = 256 #output of decoder
    ...
    for e in range(1, args.epochs+1):
        ...
        if e%10==0:
            ...
            if not os.path.isdir("./save"):
                os.makedirs("./save")
            torch.save(rvae.state_dict(), './save/input_type/dense_256/gru/arae_d256_gru_%d.pt' % (e))
            #print("[!] testing model...")
