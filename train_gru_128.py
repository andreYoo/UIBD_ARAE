...
summary = SummaryWriter('./logs/type_cell/gru_128')
...
def main():
    ...
    encoder = Encoder(log_numbers, embed_size, hidden_size, n_layers=2, dropout=0.5,cell_type='GRU')
    ...
    for e in range(1, args.epochs+1):
        ...
        if e%10==0:
            ...
            if not os.path.isdir("./save"):
                os.makedirs("./save")
            torch.save(rvae.state_dict(), './save/m_cell/gru/128/arae_gru_128_%d.pt' % (e))
            #print("[!] testing model...")
